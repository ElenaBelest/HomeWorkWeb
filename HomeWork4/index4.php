...
$experience = [
    [
        ...
        'datastart' => 01.2015,
        'datafinish' => 01.2022,
        'work' => 'Ловлю мышей и крыс превосходно',
    ],
    [
        'name' => 'Птицелов',
        'datastart' => 06.2014,
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]["datastart"];?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $experience[$i]["datafinish"];?></span></h6>
            <p><?php echo $experience[$i]["work"];?></p>
            <hr>
          </div>
          <?php endfor;?>
